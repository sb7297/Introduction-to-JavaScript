...
function hungryDog(weight, age){
  if (age < 1) {
    ...
    else if (6 <= weight && weight <= 10) return 0.04*weight;
    else if (11 <= weight && weight <= 15) return 0.03*weight;
    else if (weight > 15) return 0.02*weight;
    else return -2;
  }
}
...
function grade(score){
  if (90 <= score && score < 100) return "you got an A";
  else if (80 <= score && score < 90) return "you got a B";
  else if (70 <= score && score < 80) return "you got a C";
  else if (60 <= score && score < 70) return "you got a D";
